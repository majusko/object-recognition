...
že v skutočnosti to nie sú kruhy čo hľadáme, ale sú to elipsy.
\linebreak
\linebreak
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth,natwidth=610,natheight=642]{hladanie_kruhov.pdf}
\caption{IDEF0}
\end{figure} 
%%TODO Spravenie vyvojoveho/stavoveho diagramu
...
Tento úkon vykonáva metóda \emph{fitEllipse}, ktorá upraví kostrbaté kontúry, ktoré sa aspoň trochu podobajú na matematicky presnú elipsu.
\linebreak
\linebreak
...
Pokiaľ je výsledná hodnota vyhovujúca, nájdený ojekt vyrežeme, a zasielame na rozpoznanie neurónovej sieti, ktorá zistí o akú značku sa presne jedná.
\linebreak
\linebreak
