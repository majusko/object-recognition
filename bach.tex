...
nieco o aproximaacii
\subsubsection{Greenové vzorce}
nieco o greenových vzorcoch - nejaké integrály
...
Pri výpočte sú použité greenové vzorce. Funkcia nám vracia počet pixelov, ktoré kontúra obsahuje. Sú to pixely ktoré nemajú nulovú hodnotu.
